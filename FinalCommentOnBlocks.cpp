...
int main()
{
    ...
    string para1[10],para2[10],para3[10];
    string dataComment="The data type of the parameters respectively are ";
    string argComment="The arguments of the function respectively are ";
    string ac,bc,cc;
    string ac1,bc1,cc1;
    int paraVar1=0,paraVar2=0,paraVar3=0;
    ...
    for(int j=0; j<a.length(); j++)
    {
        ...
        if(a[j]!=' ' &&  a[j]!=',')
        {
            para1[paraVar1]=para1[paraVar1]+a[j];
        }
    ...
    for(int j=0; j<b.length(); j++)
    {
        ...
        if(b[j]!=' ' &&  b[j]!=',')
        {
            para2[paraVar2]=para2[paraVar2]+b[j];
        }
    ...
    for(int j=0; j<c.length(); j++)
    {
        ...
        if(c[j]!=' ' &&  c[j]!=',')
        {
            para3[paraVar3]=para3[paraVar3]+c[j];
        }
    ...
    if(ac!="")
    {
        ...
        for(int j=0; j<=paraVar1; j++)
        {
            if(j%2!=0)
                ac=ac+para1[j];
            if(j<paraVar1-2 && j%2!=0)
                ac=ac+',';
    ...
    if(bc!="")
    {
        ...
        for(int j=0; j<=paraVar2; j++)
        {
            cout << para2[j] << endl;
            if(j%2!=0)
                bc=bc+para2[j];
            if(j<paraVar2-2 && j%2!=0)
                bc=bc+',';
    ...
    if(cc!="")
    {
        ...
        for(int j=0; j<=paraVar3; j++)
        {
            cout << para3[j] << endl;
            if(j%2!=0)
                cc=cc+para3[j];
            if(j<paraVar3-2 && j%2!=0)
                cc=cc+',';
	...
	string f1="//The name of the function is ***" ,f2="***.The return type of the function is ***integer***";
    string f3=".The return type of the function is ***void***",f4=".The return type of the function is ***double***";
    string f5="This is the main function.";

    for(int n=0;n<forcounter;n++)
    {
        if(condition[n]=="\0")
            condition[n]="till the value of variable such as n.";
    ...
    while(getline(file,newline))
    {
        ...
        {
            if(newline.find("main") !=string::npos)
            {
                newline.append(f5);
            }
